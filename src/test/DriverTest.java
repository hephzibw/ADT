...
public class DriverTest {
    ...
    public void partitionShouldReturnSecondSmallestElementForListOfSize3AndK2() {
        ...
        assertEquals(Driver.quickSelect(numbers, 3, 2), num2);
    }
    ...
    public void fifteenNumbersScenario() {
        ...
        Number num8 = new Number(10, new LinkedList<Integer>(Arrays.asList(8, 2, 8)));
        ...
        assertEquals(Driver.quickSelect(numbers, 15, 4), num4);

    }
//    public void mainShouldCreate
}
