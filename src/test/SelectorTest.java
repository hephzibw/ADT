...
public class SelectorTest {
    ...
    public void partitionShouldReturnOneForListOfSize1AndK1() {
        main.Number[] numbers = new Number[1];
        Number num1 = new Number(2, new LinkedList<Integer>(Arrays.asList(3, 5)));
        numbers[0] = num1;
        assertEquals(Selector.quickSelect(numbers, 1, 1), num1);
    }
    ...
    public void partitionShouldReturnSecondSmallestElementForListOfSize3AndK2() {
        ...
        assertEquals(Selector.quickSelect(numbers, 3, 2).getPositionValue(), new LinkedList<Integer>(Arrays.asList(9, 2)));
    }
    ...
    public void partitionShouldReturnCorrect() {
        ...
        assertEquals(Selector.quickSelect(numbers, 5, 3), num3);
    }
    ...
    public void fifteenNumbersScenario() {
        ...
        assertEquals(Selector.quickSelect(numbers, 15, 3).getPositionValue(), new LinkedList<Integer>(Arrays.asList(5)));
